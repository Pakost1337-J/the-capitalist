...
export const BRAND_LOGO_SRC = {
  ...
  Sony: '/assets/icons/logo/sony.svg',
  Huawei: '/assets/icons/logo/huawei.svg',
  Canon: '/assets/icons/logo/canon.svg',
  Toyota: '/assets/icons/logo/toyota.svg',
  Hyundai: '/assets/icons/logo/hyundai.svg',
  Siemens: '/assets/icons/logo/siemens.svg',
  Adidas: '/assets/icons/logo/adidas.svg',
  adidas: '/assets/icons/logo/adidas.svg',
...
/** Подпись страны на клетке (как в референсе) */
...
export const BOARD = [
  ...
  // Лево: Арест → Старт (как на Monopoly Club: Nestlé → … → Coca-Cola)
  ...
  { id: 34, type: 'property', name: "McDonald's", brand: "McDonald's", country: 'US', flag: '🇺🇸', group: 'us', price: 350, houseCost: 200, rent: [35, 175, 500, 1100, 1300, 1500] },
...
/** Шанс — только пополнение денег (без телепортов) */
export const CHANCE_CARDS = [
  ...
  { text: 'Премия за удачный квартал', money: 200_000 },
  { text: 'Удачная продажа акций', money: 150_000 },
  { text: 'Кэшбэк от банка за обороты', money: 80_000 },
  { text: 'Дивиденды капнули на карту', money: 25_000 },
];

/** Форс-мажор — только штрафы (без ходов по полю) */
export const FORCE_MAJEURE_CARDS = [
  ...
  { text: 'Штраф налоговой за ошибку в отчётности.', money: -120_000 },
  { text: 'Срыв контракта — неустойка партнёру.', money: -75_000 },
];
